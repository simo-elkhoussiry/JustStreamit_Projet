function openModal(ele){
    ...
    fetch(urlMeilleurFilm)
      ...
      .then(data => {
        ...
        ul.children[1].innerHTML = `Directeur: ${data['directors']}`;
        ul.children[3].innerHTML = `Acteurs: ${data['actors']}`;
        ul.children[4].innerHTML = `Pays: ${data['countries']}`;
        ul.children[5].innerHTML = `Durée: ${data['duration']} min`;
        ul.children[6].innerHTML = `Data publication: ${data['date_published']}`;
